...
namespace mstd {
	_MSTD_INLINE17 _MSTD_CONSTEXPR20 uint32_t swap_endians(uint32_t value) noexcept {
		_MSTD_CONSTEXPR17 const uint32_t first_elem_mask = 0x000000FF;
		_MSTD_CONSTEXPR17 const uint32_t second_elem_mask = 0x0000FF00;
		_MSTD_CONSTEXPR17 const uint32_t third_elem_mask = 0x00FF0000;
		_MSTD_CONSTEXPR17 const uint32_t forth_elem_mask = 0xFF000000;
